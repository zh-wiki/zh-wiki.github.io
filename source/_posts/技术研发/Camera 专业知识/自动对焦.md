...
check persist.vendor.camera.disablePDAF是否为false;如果为true,则需adb shell setprop  persist.vendor.camera.disablePDAF FALSE
   ...
   check下<PDAFEnable>1</PDAFEnable>这一项要置1
   ```
